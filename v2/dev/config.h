...
#define HOTSPOT_TYPE_OBJECT		3
#define HOTSPOT_TYPE_PROPELLER 	4
...
#define ENABLE_HOTSPOT_PROPELLERS
#define HOTSPOT_PROPELLER_AY			12	
#define HOTSPOT_PROPELLER_VY_MAX		192
...
#define PEZON_G							16
// Make code more readable:
#define PEZON_COUNT_MAX					en_my
#define PEZON_COUNTER					en_mx
