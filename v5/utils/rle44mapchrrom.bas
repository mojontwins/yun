...
Sub usage
	Print "usage: "
	Print ""
	Print "rle44mapchrrom in=list.txt bin=chr.bin out=map.h"
...
Dim As Integer fIn, fOut, fBin, fListIn, xP, yP, x, y, i, j, first, tLock, locksI, n, cMapI, ctr, totalBytes, t0, lockssize, screensum, aaaa
...
Print "rle44mapchrrom v0.1 20171113"
...
While Not Eof (fListIn) 
	...
	Input #fListIn, aaaa
	If aaaa Then fixmappy = -1 Else fixmappy = 0
