				if (en_ud [gpit]) {
					...
					spr_id = 48 + en_s [gpit] + base_for_sprites;
				} else {
...
*/
/*
						if (en_mx [gpit] < 0 && en_x [gpit] <= en_x1 [gpit]) en_mx [gpit] = -en_mx [gpit];
						if (en_mx [gpit] > 0 && en_x [gpit] >= en_x2 [gpit]) en_mx [gpit] = -en_mx [gpit];
						if (en_my [gpit] < 0 && en_y [gpit] <= en_y1 [gpit]) en_my [gpit] = -en_my [gpit];
						if (en_my [gpit] > 0 && en_y [gpit] >= en_y2 [gpit]) en_my [gpit] = -en_my [gpit];
*/
						if ((en_mx [gpit] < 0 && en_x [gpit] <= en_x1 [gpit]) || (en_mx [gpit] > 0 && en_x [gpit] >= en_x2 [gpit])) en_mx [gpit] = -en_mx [gpit];
						if ((en_my [gpit] < 0 && en_y [gpit] <= en_y1 [gpit]) || (en_my [gpit] > 0 && en_y [gpit] >= en_y2 [gpit])) en_my [gpit] = -en_my [gpit];
					}
					spr_x = en_x [gpit];
					spr_y = en_y [gpit];
					spr_id = (base_for_sprites + en_s [gpit] << 2) + en_fr + ((en_mx [gpit] > 0 || en_my [gpit] > 0) ? 2 : 0);
				}
